...
GAMEPROJECTFILE =/home/mika/prj/TheTherapy/TheTherapy.uproject

TARGETS = \
	TheTherapy-Linux-Debug  \
	TheTherapy-Linux-DebugGame  \
	TheTherapy-Linux-Test  \
	TheTherapy-Linux-Shipping  \
	TheTherapy \
	TheTherapyEditor-Linux-Debug  \
	TheTherapyEditor-Linux-DebugGame  \
	TheTherapyEditor-Linux-Test  \
	TheTherapyEditor-Linux-Shipping  \
	TheTherapyEditor \
...
TheTherapy-Linux-Debug:
	 $(PROJECTBUILD) TheTherapy Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

TheTherapy-Linux-DebugGame:
	 $(PROJECTBUILD) TheTherapy Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

TheTherapy-Linux-Test:
	 $(PROJECTBUILD) TheTherapy Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

TheTherapy-Linux-Shipping:
	 $(PROJECTBUILD) TheTherapy Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

TheTherapy:
	 $(PROJECTBUILD) TheTherapy Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

TheTherapyEditor-Linux-Debug:
	 $(PROJECTBUILD) TheTherapyEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

TheTherapyEditor-Linux-DebugGame:
	 $(PROJECTBUILD) TheTherapyEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

TheTherapyEditor-Linux-Test:
	 $(PROJECTBUILD) TheTherapyEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

TheTherapyEditor-Linux-Shipping:
	 $(PROJECTBUILD) TheTherapyEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

TheTherapyEditor:
	 $(PROJECTBUILD) TheTherapyEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
